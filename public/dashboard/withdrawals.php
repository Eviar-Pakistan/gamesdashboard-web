            ...
            <div class="main-content app-content mt-0">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row row-sm" ng-init="fetchWithdrawals()">
                            <div class="col-lg-12">
                                <div class="card">
                                            ...
                                            <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">Withdraw Account title</th>
                                                        <th class="wd-15p border-bottom-0">Withdraw Account number</th>
