...
<body class="app sidebar-mini ltr light-mode" ng-app="myAngularApp" ng-controller="adminController" ng-init="fetchBids()">
            ...
            <div class="main-content app-content mt-0">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-12 col-xl-3">
                                <div class="card">
                                    <div class="row">
                                        ...
                                        <div class="col-8" ng-init="usersCount()">
                                            <div class="card-body p-4">
                                                <h2 class="mb-2 fw-normal mt-2">{{userCount}}</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="card-img-absolute circle-icon bg-secondary align-items-center text-center box-secondary-shadow bradius">
                                                <img src="../assets/images/svgs/circle.svg" alt="img" class="card-img-absolute">
                                                <i class="fa fa-coins fs-30 text-white mt-4"></i>
                                                <!-- <i class="lnr lnr-pencil fs-30 text-white mt-4"></i> -->

                                            </div>
                                        </div>
                                        <div class="col-8" ng-init="checkBalance()">
                                            <div class="card-body p-4">
                                                <h2 class="mb-2 fw-normal mt-2">{{balance}}</h2>
                                                <h5 class="fw-normal mb-0">Total Coins</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="card-img-absolute  circle-icon bg-success align-items-center text-center box-success-shadow bradius">
                                                <img src="../assets/images/svgs/circle.svg" alt="img" class="card-img-absolute">
                                                <i class="fa fa-dice-six fs-30 text-white mt-4"></i>
                                        ...
                                        <div class="col-8">
                                            <div class="card-body p-4">
                                                <h2 class="mb-2 fw-normal mt-2">4</h2>
                                                <h5 class="fw-normal mb-0">Total Games</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="card-img-absolute circle-icon bg-danger align-items-center text-center box-danger-shadow bradius">
                                                <img src="../assets/images/svgs/circle.svg" alt="img" class="card-img-absolute">
                                                <i class="fa fa-horse-head fs-30 text-white mt-4"></i>
                                        ...
                                        <div class="col-8">
                                            <div class="card-body p-4">
                                                <h2 class="mb-2 fw-normal mt-2">9</h2>
                                                <h5 class="fw-normal mb-0">Total Horse</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button class="btn btn-danger" ng-click="resetBids()">Reset Bids</button>
                        <button class="btn btn-success" ng-click="giveReward()">Give Reward</button>
                        <br><br>
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3" ng-repeat="(key, value) in hourBids">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title mb-0">{{key}}</h3>
                                    </div>
                                    <!-- 
                                    new start -->
                                        ...
                                        <form method="post" class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="form-label">Winner Horse</label>
                                                    <select class="form-control form-select" data-placeholder="Choose one" id="mySelectHorse" onchange="updateWinnerHourse('01:00 PM')">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                                                        <thead class="border-top">
                                                                            <tr>
                                                                                <th class="bg-transparent border-bottom-0" style="width: 5%;">Horse No</th>
                                                                        ...
                                                                        <tbody>
                                                                            <tr class="border-bottom" ng-repeat="h in value" ng-click="selectWinnerHorse(key,h.horse_no)" ng-class="{'green-class': h.is_winner_horse==true}">
                ...
                <div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
                    <div class="tabs-menu border-bottom">
                        ...
                        <ul class="nav panel-tabs">
                            <li class=""><a href="#sidebar-side1" class="active" data-bs-toggle="tab"><i class="fe fe-settings me-1"></i>Feeds</a></li>
                        ...
                        <ul class="row p-3">
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/us_flag.jpg" class="me-3 language"></span>USA
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/italy_flag.jpg" class="me-3 language"></span>Italy
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/spain_flag.jpg" class="me-3 language"></span>Spain
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/india_flag.jpg" class="me-3 language"></span>India
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/french_flag.jpg" class="me-3 language"></span>French
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/russia_flag.jpg" class="me-3 language"></span>Russia
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/germany_flag.jpg" class="me-3 language"></span>Germany
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/argentina.jpg" class="me-3 language"></span>Argentina
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/malaysia.jpg" class="me-3 language"></span>Malaysia
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="../assets/images/flags-img/turkey.jpg" class="me-3 language"></span>Turkey
                                </a>
                            </li>
                        </ul>
                    </div>
