...
<body class="app sidebar-mini ltr light-mode" ng-app="myAngularApp" ng-controller="adminController">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <div class="main-content app-content mt-0" ng-init="fetchAccountsEasy()">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">E 4 Earning</a></li>
                        ...
                        <div class="row" ng-init="checkBalance()">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-lg-12">
                                                <a href="javascript:void(0)" class="btn btn-info col-lg-12" ng-click="updateAdmin()">Update</a>
                                            </div>
                        ...
                        <div class="row" ng-init="checkBalance()">
                            <div class="col-xl-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Update EasyPaisa deposit details</h3>
                                    </div>
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="row row-sm">
                                            <div class="form-group">
                                                <select class="form-control select2 form-select" id="mySelect" data-placeholder="Choose one">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Account Title" ng-model="titleEasy">
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label"> Account Number</label>
                                                <input type="text" class="form-control" placeholder="Account Number" ng-model="numberEasy">
                                            </div>
                                            <div class="col-lg-12">
                                                <a href="javascript:void(0)" class="btn btn-info col-lg-12" ng-click="updateAccountsEasy()">Update</a>
                                            </div>
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Update JazzCash deposit details</h3>
                                    </div>
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="row row-sm">
                                            <div class="form-group">
                                                <select class="form-control select2 form-select" id="mySelect" data-placeholder="Choose one">
                                                    ...
                                                    <option value="EasyPaisa" selected>JazzCash</option>

                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label"> Account Title</label>
                                                <input type="text" class="form-control" placeholder="Account Title" ng-model="titleJazz">
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label"> Account Number</label>
                                                <input type="text" class="form-control" placeholder="Account Number" ng-model="numberJazz">
                                            </div>
                                            <div class="col-lg-12">
                                                <a href="javascript:void(0)" class="btn btn-info col-lg-12" ng-click="updateAccountsJazz()">Update</a>
                                            </div>
