...
<body class="app sidebar-mini ltr light-mode" ng-app="myAngularApp" ng-controller="adminController">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <div class="main-content app-content mt-0" ng-init="getAllUsers()">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Transfer Coins</h1>
                            <div>
                                <ol class="breadcrumb">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Enter Transfer Data Avaiable Coins ({{balance}})</h3>
                                    </div>
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="row row-sm">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2-show-search form-select" id="mySelect" data-placeholder="Choose one" onchange="pickUser()">
                                                    <option label="Choose one"></option>
                                                    <option value="{{u.code}}" ng-repeat="u in allUsers">{{u.name}} - Transfer Code: {{u.code}}</option>

                                                </select>
                                            </div>

                                            <div class="col-lg-12">
                                                <input class="form-control mb-4" placeholder="Enter Coins To Transfer" type="text" ng-model="coins">
                                            </div>
                                            <div class="col-lg-12">
                                                <a href="javascript:void(0)" class="btn btn-info col-lg-12" ng-click="transferCoins()">Transfer</a>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Generate Coins Avaiable Coins ({{balance}})</h3>
                                    </div>
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-lg-12">
                                                <input class="form-control mb-4" placeholder="Enter Coins To Generate" type="text" ng-model="coinsGenerate">
                                            </div>
                                            <div class="col-lg-12">
                                                <a href="javascript:void(0)" class="btn btn-info col-lg-12" ng-click="generateCoins()">Generate</a>
                                            </div>
