...
<body class="app sidebar-mini ltr light-mode" ng-app="myAngularApp" ng-controller="adminController" ng-init="fetchPurchasedCoins()">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title mb-0">Purchased Coins</h3>
                                    </div>
                                                            ...
                                                            <div class="tab-pane active" id="tab5">
                                                                <div class="table-responsive">
                                                                    <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            <tr class="border-bottom" ng-repeat="p in purchasedCoins">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title mb-0">Used Coins</h3>
                                    </div>
                                    <div class="card-body pt-4">
                                        <div class="grid-margin">
                                            <div class="">
                                                            ...
                                                            <div class="tab-pane active" id="tab5">
                                                                <div class="table-responsive">
                                                                    <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            <tr class="border-bottom" ng-repeat="p in usedCoins">
                                                                                <td class=" text-center">
                                                                                    <div class="mt-0 mt-sm-2 d-block">
                                                                                        <h6 class="mb-0 fs-14 fw-semibold">
                                                                                            {{p.name}}
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title mb-0">Won Coins</h3>
                                    </div>
                                    <div class="card-body pt-4">
                                        <div class="grid-margin">
                                            <div class="">
                                                            ...
                                                            <div class="tab-pane active" id="tab5">
                                                                <div class="table-responsive">
                                                                    <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            <tr class="border-bottom" ng-repeat="p in wonCoins">
                                                                                <td class=" text-center">
                                                                                    <div class="mt-0 mt-sm-2 d-block">
                                                                                        <h6 class="mb-0 fs-14 fw-semibold">
                                                                                            {{p.name}}
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title mb-0">Withdrawn Coins</h3>
                                    </div>
                                    <div class="card-body pt-4">
                                        <div class="grid-margin">
                                            <div class="">
                                                            ...
                                                            <div class="tab-pane active" id="tab5">
                                                                <div class="table-responsive">
                                                                    <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            <tr class="border-bottom" ng-repeat="p in withdrawCoinsList">
                                                                                <td class=" text-center">
                                                                                    <div class="mt-0 mt-sm-2 d-block">
                                                                                        <h6 class="mb-0 fs-14 fw-semibold">
                                                                                            {{p.name}}
